...
public class AuthenticationController {
    ...
    public String addPlant(@RequestBody BookAdd request){
        return service.AddPlant(request);
    }
    @GetMapping("/plant/getplant/{plantId}")
    public ResponseEntity<Optional<Book>> getplantById(@PathVariable long plantId){
    	return ResponseEntity.ok(service.getPlantById(plantId));
    }
    @GetMapping("/plant/getall")
    public ResponseEntity<List<Book>> getAllplant(){
    ...
    public ResponseEntity<String> updateplantById(@PathVariable long plantId,@RequestBody BookAdd request){
