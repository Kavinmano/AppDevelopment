      ...
      <div className="row ">
        <div className="col-md-12 d-flex flex-column align-items-center justify-content-center " style={{height:"80vh"}}>
          <div className='align-items-center' >    
           ...
           <div>
          <p>Welcome to our Hogwarts's Library Management System. We Have a unique expirence in Library Management System and even if you say any spell name according to the spell we will give some disounts and gifts to our users</p></div>
          <div>
          <p>
